...
begin
  lbResults.Caption := 'Найденный путь:'#13#10 + Info.PathString +
    #13#10 + #13#10;
  lbResults.Caption := lbResults.Caption + 'Количество дуг в пути: ' +
    IntToStr(Info.ArcsCount) + #13#10;
  lbResults.Caption := lbResults.Caption + 'Длина найденного пути: ' +
    IntToStr(Info.Distance) + #13#10;
  lbResults.Caption := lbResults.Caption + 'Количество посещений: ' +
